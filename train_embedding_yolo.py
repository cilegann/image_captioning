...
cbckpt = ModelCheckpoint('vgg_best_weight.h5',monitor='loss', verbose=1, save_best_only=True, mode='min')
...
try:
    ...
    model.save_weights('./vgg_keyboardInterrupt_saved_weight.h5')
...
print("Train done")
model.save_weights('./vgg_model_weight2.h5')
